module Admin::V1
  class ProductsController < ApiController
    ...
    def create
      ...
      render_error(fields: @saving_service.errros)
    end
    ...
    def product_params
      ...
      permitted_params = params.require(:product).permit(:id, 
        :name, :description, :image, :price, :productable, :status, 
        :featured, category_ids: []
      )
    ...
    def productable_params
      productable_type = params[:product][:productable] || @product&.productable_type&._undescore
